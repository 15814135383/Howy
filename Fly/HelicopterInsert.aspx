<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HelicopterInsert.aspx.cs" Inherits="Maticsoft.Web.Fly.HelicopterInsert" %>
 ...
 <script type="text/javascript"> 
  $(function () {
      ...
      $("#LookList").click(function () {       
          window.open("LookList.aspx", "", "top=100,left=200,width=1004,height=800,toolbar=yes, menubar=yes, scrollbars=yes, resizable=yes,location=yes, status=yes'");
          //window.showModelessDialog("AddNotes.aspx");//对话框形式打开
      });
...
<table width="1100"  cellspacing="0" cellpadding="0" border="1">
      <tr>
    <th colspan="4" scope="col" class="auto-style1"><div align="left" style="margin-left:5px;margin-top:2px;margin-bottom:1px">
        <asp:Button ID="BtnSaveData" runat="server" BackColor="#3C95C8" BorderStyle="None" Text="Save Data" Font-Bold="True" Font-Italic="False"  Font-Strikeout="False" ForeColor="White" OnClick="BtnSaveData_Click" Height="30px"/>
        ...
        <input id="LookList" runat="server" style="background-color:#3C95C8; font-weight: bold; color: #FFFFFF; height:30px;margin-left:2px;margin-top:2px;margin-bottom:1px" type="button" value="Look List" /></div></th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="300" scope="col" class="auto-style1">
        <asp:TextBox ID="TxtCARID" runat="server" Width="186px" ReadOnly="true"></asp:TextBox>
        <span style="margin-left:5px"><asp:Button ID="BtnAddCARID" runat="server" BackColor="#3C95C8" BorderStyle="None" Text="Add CAR ID" Font-Bold="True" Font-Italic="False"  Font-Strikeout="False" ForeColor="White" Width="100px" OnClick="BtnAddCARID_Click" /></span>
      </td>
	         ...
	         <div>
				...
				<input id="btnCancel1" type="button" value="Cancel Upload" onclick="swfu1.cancelQueue();" disabled="disabled"  style="margin-left: 2px;; font-size: 9pt; background-color:#3C95C8; font-weight: bold; color: #FFFFFF;" class="auto-style6"  /> <span class="STYLE4">
                  <input id="btnUpload" type="button" value="Upload Photos"
                        onclick="startUploadIMG();"  class="auto-style4" style="background-color:#3C95C8; font-weight: bold; color: #FFFFFF;" 
                        /></span>
			</div>
			<p>&nbsp;</p>
...
<table width="1100" border="1" cellspacing="0" cellpadding="0" style="margin-top:5px">
      <tr>
